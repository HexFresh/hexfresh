...
import { StatsHeader } from "../../components/fresher/statistic/statistic-header.component";
...
export const messageStore: any = {
  ...
  reducers: {
    ...
    resetMessageState: (state: IRootStore, payload: any) => ({ ...messageInitialState }),
    resetSelectedMessage: (state: IRootStore) => ({...state, selectedConversation: messageInitialState.selectedConversation}),
  },
